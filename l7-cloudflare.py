####################################################
################    Gabriel CMR     ################
##### Atencao desenvolvido para fins educativo #####
################    CMR Services    ################
####################################################
...
def downloadProxys():
    ...
    print("Download das proxys feito com sucesso!")
...
class Ataque(threading.Thread):
    def run(self):
        ...
        httprequest = httprequest.encode('utf-8')
...
if __name__ == "__main__":
    ...
    try:
        download_proxy = sys.argv[3]
    except:
        download_proxy = input("Download das Proxy(Y/N)? ")
